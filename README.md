...
Ultimately, we didn't use this framework because the training requires too many GPUs. But it's good code to read over if you're bored/you can maybe implement it on a machine with multiple GPUs (mine had 0, Colab gives you 1 for free).
